...
/* common between HAL1 and HAL3 */
    ...
    PRINT(CAM_INTF_META_AEC_PRECAPTURE_ID,          pMetadata);
    ...
    PRINT(CAM_INTF_META_AF_TRIGGER_ID,             pMetadata);
    ...
    PRINT(CAM_INTF_META_EDGE,                       pMetadata);
   ...
   // PRINT(CAM_INTF_PARM_AEC_ENABLE,             pMetadata);
    ...
    //PRINT(CAM_INTF_PARM_AWB_ENABLE,              pMetadata);
    // PRINT(CAM_INTF_PARM_AF_ENABLE,              pMetadata);
    PRINT(CAM_INTF_PARM_WHITE_BALANCE,           pMetadata);
    ...
    PRINT(CAM_INTF_PARM_AF_MOBICAT_CMD,           pMetadata);
    ...
    PRINT(CAM_INTF_META_STATS_HISTOGRAM_MODE,     pMetadata);
    PRINT(CAM_INTF_META_STATS_SHARPNESS_MAP_MODE, pMetadata);
    PRINT(CAM_INTF_META_TONEMAP_CURVE_BLUE,       pMetadata);
    PRINT(CAM_INTF_META_TONEMAP_CURVE_GREEN,      pMetadata);
    PRINT(CAM_INTF_META_TONEMAP_CURVE_RED,        pMetadata);
    PRINT(CAM_INTF_META_TONEMAP_MODE,             pMetadata);
    PRINT(CAM_INTF_META_FLASH_MODE,               pMetadata);
    PRINT(CAM_INTF_PARM_STATS_DEBUG_MASK,         pMetadata);
    PRINT(CAM_INTF_PARM_ISP_DEBUG_MASK,           pMetadata);
    PRINT(CAM_INTF_PARM_ALGO_OPTIMIZATIONS_MASK,  pMetadata);
    PRINT(CAM_INTF_PARM_SENSOR_DEBUG_MASK,        pMetadata);
    PRINT(CAM_INTF_PARM_FOCUS_BRACKETING,         pMetadata);
    PRINT(CAM_INTF_PARM_MULTI_TOUCH_FOCUS_BRACKETING, pMetadata);
